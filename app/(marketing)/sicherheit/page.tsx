        ...
        <>
            ...
            <section className="pt-[72px] bg-white">
                <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-20 sm:pt-28 lg:pt-36 pb-16">
                    <div className="max-w-3xl">
                        <p className="text-xs font-mono font-bold text-slate-400 mb-4">SICHERHEIT</p>
                        <h1 className="text-3xl sm:text-4xl lg:text-[48px] font-extrabold text-[#1E293B] tracking-tight leading-[1.1] mb-6">
                            ...
                            <span className="text-slate-400">Wir behandeln sie auch so.</span>
                        </h1>
            ...
            <section className="py-20 lg:py-28">
                <div className="max-w-7xl mx-auto px-5 sm:px-8 space-y-16 lg:space-y-24">
                    {layers.map((layer) => (
                        <div key={layer.title}>
                            <h2 className="text-xl sm:text-2xl font-extrabold text-[#1E293B] tracking-tight mb-8">
                                {layer.title}
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {layer.items.map((item) => (
                                    <div key={item.label} className="bg-slate-50 rounded-xl p-6 lg:p-8">
                                        <h3 className="text-sm font-bold text-[#1E293B] mb-2">{item.label}</h3>
            ...
            <section className="py-20 lg:py-28 bg-[#1E293B]">
                <div className="max-w-7xl mx-auto px-5 sm:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.06] rounded-xl overflow-hidden">
                        {dsgvoArticles.map((a) => (
                            <div key={a.article} className="bg-[#1E293B] p-7 lg:p-9 hover:bg-white/[0.03] transition-colors">
                                <span className="text-xs font-mono font-bold text-slate-500 block mb-3">{a.article}</span>
            ...
            <section className="py-20 lg:py-28 bg-white">
                <div className="max-w-7xl mx-auto px-5 sm:px-8">
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1E293B] tracking-tight mb-8">
                        ...
                        <div className="space-y-0">
                            {[
                                ...
                                <div key={s.step} className="flex gap-6 py-6 border-b border-slate-100 last:border-0">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-bold text-[#1E293B] mb-1">{s.label}</h3>
            ...
            <section className="py-20 lg:py-24 bg-slate-50">
                <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
                    ...
                    <Link href="/kontakt">
                        <Button className="bg-[#1E293B] text-white hover:bg-[#0F172A] h-12 px-8 rounded-lg text-sm font-semibold cursor-pointer">
