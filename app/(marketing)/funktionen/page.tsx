...
const modules = [
    ...
    },
    {
        ...
        capabilities: [
            ...
            'Mitarbeiter: kein Self-Service-Zugriff aktiviert',
    ...
    },
    {
        ...
        capabilities: [
            'HR-geführter Auskunftsprozess',
            'Audit-Trail für Anfragen und Antworten',
            'Dokumentierte Fristen und Verantwortlichkeiten',
            'Keine Offenlegung interner Gehaltsvergleiche im Mitarbeiterportal',
            'Nachweise für externe Prüfungen exportierbar',
        ],
    },
    {
        number: '05',
