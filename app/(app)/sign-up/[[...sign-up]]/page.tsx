            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#f9f9f9]">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl border border-[#e0e0e2] shadow-lg p-8">
                        <h2 className="text-2xl font-extrabold text-[#071423] tracking-tight mb-2">Konto erstellen</h2>
                        <p className="text-sm text-[#535a6b] mb-6">
                            Starten Sie jetzt mit klargehalt — EU-konform, sicher, einfach.
                        </p>
                        <Link href="/auth/sign-up" className="block mb-4">
                        ...
                        <p className="text-sm text-[#535a6b]">
                            Bereits registriert?{' '}
                            <Link href="/sign-in" className="text-[#946df7] font-semibold hover:underline">
                                Anmelden
                            </Link>
                        </p>
                    </div>
