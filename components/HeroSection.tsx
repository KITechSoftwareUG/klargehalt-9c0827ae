  ...
  return (
    <section className="relative overflow-hidden pt-[72px]">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 70% 30%, rgba(37,99,235,0.05) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-16 sm:pt-24 lg:pt-32 pb-16 lg:pb-24">
        ...
        <div className="mb-8 animate-fade-in opacity-0">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200/60 text-amber-700 text-xs font-semibold tracking-wide">
            <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse-gentle" />
            Gesetzliche Pflicht ab Juni 2026
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          {/* Left — 7 cols */}
          <div className="lg:col-span-7 animate-fade-in opacity-0 animation-delay-100">
            {/* Wordmark — large */}
            <div className="mb-6">
              <Image
                src="/brandname.svg"
          ...
          <div className="lg:col-span-5 animate-fade-in opacity-0 animation-delay-200">
            <div className="bg-white rounded-2xl border border-slate-200/70 shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-8">
